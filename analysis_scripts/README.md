...
| No18 | セブンイレブン・栄養バランス | No17で人数・利用日数を揃えた二群について、対応商品を除外した普段の購買記録を「軽食・補助食型」「食事中心型」に分類し、選択数を比較 | `No18_compare_meal_role/Input/compare_meal_role.py` |
...
9. No18：条件調整後の二群で、普段選ぶ食事形態の違いを比較
